...
\begin{center}
{\centering
\vbox{\centerline{\includegraphics[width=6cm]{figures/Fig1-eps-converted-to.pdf}} \vskip1mm {\small
图\ 1\quad 双栏图片示例
\\
...
\begin{center}
{\centering
\vbox{\centerline{\includegraphics[width=16cm]{figures/Fig2-eps-converted-to.pdf}} \vskip1mm {\small
图\ 2\quad 通栏图片示例
\\
...
\begin{biography}[figures/bio/ssl-eps-converted-to.pdf]
\noindent{\hei
尚书林
}\quad
中国科学院自动化研究所博士研究生.
...
\begin{biography}[figures/bio/nmzuo-eps-converted-to.pdf]
\noindent{\hei
左年明
}\quad
中国科学院自动化研究所博士研究生.
