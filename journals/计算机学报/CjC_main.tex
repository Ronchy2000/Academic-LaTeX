...
\usepackage{epstopdf}
\input{zhwinfonts} % load Windows font maps before document begins
%\usepackage{ccmap}
%\CJKtilde
%\usepackage{CJKpunct} 
...
\noindent\begin{CJK*}{UTF8}{hei}摘\quad 要\quad \end{CJK*} \begin{CJK*}{UTF8}{song}
...
\zihao{5-}{\noindent
\begin{CJK*}{UTF8}{hei}关键词\end{CJK*} \quad \begin{CJK*}{UTF8}{song}{*关键词（中文关键字与英文关键字对应且一致，应有5-7个关键词)；关键词；关键词；关键词*  }
\end{CJK*}
}\\[2mm]
\zihao{5-}{\begin{CJK*}{UTF8}{hei}中图法分类号\end{CJK*}	\begin{CJK*}{UTF8}{song}
TP\end{CJK*}\rm{\quad \quad \quad     }
\begin{CJK*}{UTF8}{hei}DOI号:\end{CJK*}\begin{CJK*}{UTF8}{song}
*投稿时不提供DOI号\end{CJK*}}
\end{tabular}}
...
\begin{center}
\zihao{3}{ {\begin{CJK*}{UTF8}{hei}Title *（中英文题目一致)字体为4号Times New Roman,加粗* Title\end{CJK*}}}\\
\vspace {5mm}
\zihao{5}{ {\begin{CJK*}{UTF8}{hei}NAME Name-Name$^{1)}$ NAME Name$^{2)}$ NAME Name-Name$^{3)}$ *字体为5号Times
new Roman*Name\end{CJK*}
}}\\
\vspace {2mm}
\zihao{6}{\begin{CJK*}{UTF8}{hei}{$^{1)}$(Department of ****, University, City ZipCode, China) *字体为6号Times
new Roman* Depart.Correspond}\end{CJK*}}

\zihao{6}{\begin{CJK*}{UTF8}{hei}{$^{2)}$(Department of ****, University, City ZipCode)*中国不写国家名*}\end{CJK*}}

\zihao{6}{\begin{CJK*}{UTF8}{hei}{$^{3)}$(Department of ****, University, City ZipCode, country)*外国写国家名*}\end{CJK*}}
...
{\bf Abstract}\quad \begin{CJK*}{UTF8}{hei}(\textbf{500英文单词，内容包含中文摘要的内容}).
...
\vspace {5mm}
{\bf Keywords}\quad \begin{CJK*}{UTF8}{hei}中文关键字与英文关键字对应且一致，\textbf{不要用英文缩写});
...
{\begin{CJK*}{UTF8}{hei}\subsection{二级标题 *字体为5号黑体*标题2}\end{CJK*}}
...
{\begin{CJK*}{UTF8}{hei}\textbf{定理1}.\end{CJK*}}\quad ******. *定理内容.*

[``定义''、``假设''、``公理''、``引理''等的排版格式与此相同，详细定理证明、公式可放在附录中]

{\begin{CJK*}{UTF8}{fs}证明\end{CJK*}}.\quad  *证明过程.* [``例 x''等的排版格式相同]
...
\begin{table}[htbp]
\centering {\begin{CJK*}{UTF8}{hei}表X\quad 表说明 *表说明采用黑体*\end{CJK*}}
\vspace {-2.5mm}
\begin{center}
\begin{tabular}{ll}
\toprule
...
\begin{CJK*}{UTF8}{hei}过程X.\end{CJK*}\quad 过程名称

{\zihao{5-}*《计算机学报》的方法过程描述字体为小5号宋体，IF、THEN等伪代码关键词全部用大写字母，变量和函数名称用斜体*}


\begin{CJK*}{UTF8}{hei}算法\textbf{Y}\end{CJK*}.\quad 算法名称.
\zihao{5-}{
...
\vspace {3mm}
\zihao{5}{
\noindent \begin{CJK*}{UTF8}{hei}致\quad 谢\end{CJK*}\quad \begin{CJK*}{UTF8}{kai} *致谢内容.* 致谢\end{CJK*}}


\vspace {5mm}
\centerline
{\zihao{5}
\begin{CJK*}{UTF8}{hei}参~考~文~献\end{CJK*}}
